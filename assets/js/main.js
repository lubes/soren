$(document).ready(function() {
    ...
    $(window).on("scroll touchmove", function() {
        if ($(document).scrollTop() >= $("#soren").position().top -300) {
            $('body').css('background', $("#soren").attr("data-color"));
            $('.projects').removeClass('in-view');
            $('.contact').removeClass('in-view');
        };
        if ($(document).scrollTop() > $("#projects").position().top -300) {
            $('body').css('background', $("#projects").attr("data-color"));
            $('.projects').addClass('in-view');
            $('.contact').removeClass('in-view');
        };
        if ($(document).scrollTop() > $("#contact").position().top -300) {
